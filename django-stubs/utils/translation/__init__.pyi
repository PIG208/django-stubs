...
def gettext_lazy(message: str) -> Promise[Tuple[str]]: ...
def pgettext_lazy(context: str, message: str) -> Promise[Tuple[str]]: ...
def ngettext_lazy(singular: str, plural: str, number: Union[int, str, None] = ...) -> Promise[Tuple[str]]: ...
def npgettext_lazy(
