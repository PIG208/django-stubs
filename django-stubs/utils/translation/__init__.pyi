...
def gettext_lazy(message: str) -> Promise[Tuple[str], str]: ...
def pgettext_lazy(context: str, message: str) -> Promise[Tuple[str], str]: ...
def ngettext_lazy(singular: str, plural: str, number: Union[int, str, None] = ...) -> Promise[Tuple[str], str]: ...
def npgettext_lazy(
    context: str, singular: str, plural: str, number: Union[int, str, None] = ...
) -> Promise[Tuple[str], str]: ...
