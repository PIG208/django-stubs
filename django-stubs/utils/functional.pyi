...
class Promise(Generic[_ResultClassT]):
...
def lazystr(text: Any) -> Promise[Tuple[str]]: ...
def keep_lazy(*resultclasses: Any) -> Callable[[Callable[..., Any]], Promise[Any]]: ...
def keep_lazy_text(func: Callable[..., str]) -> Callable[..., Promise[Tuple[str]]]: ...
